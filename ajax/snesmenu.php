...
/**
 *       \file       htdocs/mealplanner/ajax/snesmenu.php
 *       \brief      File to return Ajax response on snesmenu list request
 */
...
// Security check
if (!$user->hasRight('mealplanner', 'snesmenu', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax mealplanner/ajax/snesmenu.php");
