...
/**
 *       \file       htdocs/mealplanner/ajax/snes_menu.php
 *       \brief      File to return Ajax response on snes_menu list request
 */
...
dol_include_once('/mealplanner/class/snes_menu.class.php');
...
$object = new Snes_menu($db);

// Security check
if (!$user->hasRight('mealplanner', 'snes_menu', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax mealplanner/ajax/snes_menu.php");
