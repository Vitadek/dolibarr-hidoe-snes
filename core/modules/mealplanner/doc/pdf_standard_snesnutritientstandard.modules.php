...
/**
 *  \file       core/modules/mealplanner/doc/pdf_standard.modules.php
 *  \ingroup    mealplanner
...
/**
 *	Class to manage PDF template standard_snesnutritientstandard
 */
class pdf_standard_snesnutritientstandard extends ModelePDFSnesNutritientStandard
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	SnesNutritientStandard	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('MEALPLANNER_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('MEALPLANNER_DRAFT_WATERMARK')));
		}
